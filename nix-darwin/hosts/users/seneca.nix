# User configuration for asmith (Cisco/Seneca)
{
  ...
  home = {
    ...
    # Volta setup activation (using default tools only for work machine)
    activation.setupVolta = lib.hm.dag.entryAfter ["writeBoundary"] (
      let
        # Only use default tools for work machine
      ...
      in ''
        ...
        echo "Checking npm tools for Cisco work environment..."

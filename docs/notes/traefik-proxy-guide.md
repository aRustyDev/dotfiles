...
title: Traefik Proxy Configuration Guide
...
related:
  - ref: "[[multiple-db-uis]]"
    description: Database UI routing patterns
  - ref: "[[mcp-traefik-deployment]]"
    description: MCP service deployment with Traefik
  - ref: "[[docker-profiles]]"
    description: Docker Compose profile strategy
---

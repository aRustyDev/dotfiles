...
# =============================================================================
# Wraps the official meilisearch-mcp stdio server with supergateway to provide
# Streamable HTTP transport.
#
# Build:
#   docker build -f meilisearch-mcp.dockerfile -t meilisearch-mcp:http .
#
# Run:
#   docker run -p 8080:8080 \
#     -e MEILI_HTTP_ADDR=http://meilisearch:7700 \
#     -e MEILI_MASTER_KEY=your-master-key \
#     meilisearch-mcp:http
#
# Source: https://github.com/meilisearch/meilisearch-mcp
# =============================================================================

FROM getmeili/meilisearch-mcp:latest
...
# Meilisearch connection (override at runtime)

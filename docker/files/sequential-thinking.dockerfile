# =============================================================================
# Sequential Thinking MCP Server - Streamable HTTP
# =============================================================================
# Wraps the official mcp/sequentialthinking stdio server with supergateway
# to provide Streamable HTTP transport.
#
# Build:
#   docker build -f sequential-thinking.dockerfile -t sequential-thinking-mcp:http .
#
# Run:
#   docker run -p 8080:8080 sequential-thinking-mcp:http
#
